                ...
                <div class="card-body pt-6">
                    ...
                    <ul class="nav nav-pills nav-pills-custom mb-4 ">
                        ...
                        <li class="nav-item mb-3 me-3 me-lg-6">
                            <!--begin::Link-->
                            <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-120px h-85px pt-5 pb-2 active"
                                ...
                                <!--end::Icon-->
                                <!--begin::Title-->
                                <span class="nav-text text-gray-800 fw-bold fs-6 lh-1"> الوظائف</span>
                                <!--end::Title-->
                                <!--begin::Bullet-->
                        ...
                        <li class="nav-item mb-3 me-3 me-lg-6">
                            <!--begin::Link-->
                            <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-120px h-85px pt-5 pb-2 "
                                ...
                                <!--end::Icon-->
                                <!--begin::Title-->
                                <span class="nav-text text-gray-800 fw-bold fs-6 lh-1">الدورات والاستشارات</span>
                                <!--end::Title-->
                                <!--begin::Bullet-->
                                <span class="bullet-custom position-absolute bottom-0 w-100 h-4px bg-primary"></span>
                                <!--end::Bullet-->
                        ...
                        <li class="nav-item mb-3 me-3 me-lg-6">
                            ...
                            <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-120px h-85px pt-5 pb-2"
                                ...
                                <!--end::Icon-->
                                <!--begin::Title-->
                                <span class="nav-text text-gray-800 fw-bold fs-6 lh-1">دعم المشاريع</span>
                                <!--end::Title-->
                                <!--begin::Bullet-->
                                <span class="bullet-custom position-absolute bottom-0 w-100 h-4px bg-primary"></span>
                                <!--end::Bullet-->
                        ...
                        <li class="nav-item mb-3 me-3 me-lg-6">
                            ...
                            <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-120px h-85px pt-5 pb-2"
                                ...
                                <!--begin::Icon-->
                                <div class="nav-icon mb-3">
                                    <i class="ki-duotone ki-chrome fs-1">
                                        <i class="path1"></i>
                                        <i class="path2"></i>
                                    </i>
                                </div>
                                <!--end::Icon-->
                                <!--begin::Title-->
                                <span class="nav-text text-gray-800 fw-bold fs-6 lh-1">الاجتماعات عائلية</span>
                                <!--end::Title-->
                                <!--begin::Bullet-->
                                <span class="bullet-custom position-absolute bottom-0 w-100 h-4px bg-primary"></span>
                                <!--end::Bullet-->
                        ...
                        <li class="nav-item mb-3 me-3 me-lg-6">
                            ...
                            <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-120px h-85px pt-5 pb-2"
                                ...
                                <!--begin::Icon-->
                                <div class="nav-icon mb-3">
                                    <i class="ki-duotone ki-discount fs-1">
                                        <i class="path1"></i>
                                        <i class="path2"></i>
                                    </i>
                                </div>
                                <!--end::Icon-->
                                <!--begin::Title-->
                                <span class="nav-text text-gray-800 fw-bold fs-6 lh-1">الخصومات والعروض</span>
                                <!--end::Title-->
                                <!--begin::Bullet-->
                                <span class="bullet-custom position-absolute bottom-0 w-100 h-4px bg-primary"></span>
                                <!--end::Bullet-->
                    ...
                    <div class="tab-content">
                                        ...
                                        <div class="card-body pt-7 px-0">
                                            ...
                                            <div class="float-end d-none">
                                                <a href="#" class="btn btn-sm btn-light me-2"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#kt_modal_create_project">Add
                                                    Lesson</a>
                                                <a href="#" class="btn btn-sm btn-danger"
                                                    data-bs-toggle="modal" data-bs-target="#kt_modal_create_app">Call
                                                    Sick for Today</a>
                                            </div>
                                            <!--end::Action-->
                                        </div>
                                                    ...
                                                    <div class="d-flex flex-stack position-relative mt-8">
                                                        ...
                                                        <div class="fw-semibold ms-5 text-gray-600">
                                                            ...
                                                            <div class="fs-5">10:00 - 11:00
                                                                <span
                                                                    class="fs-7 text-gray-400 text-uppercase">am</span>
                                                            </div>
                                                            <!--end::Time-->
                                                            <!--begin::Title-->
                                                            <a href="#"
                                                    ...
                                                    <div class="d-flex flex-stack position-relative mt-8">
                                                        ...
                                                        <div class="fw-semibold ms-5 text-gray-600">
                                                            ...
                                                            <div class="fs-5">13:00 - 14:00
                                                                <span
                                                                    class="fs-7 text-gray-400 text-uppercase">pm</span>
                                                            </div>
                                                            <!--end::Time-->
                                                            <!--begin::Title-->
                                                            <a href="#"
                        ...
                        <!--end::Tap pane-->
                        <!--begin::Tap pane-->
                        <div class="tab-pane fade show active" id="kt_stats_widget_16_tab_5">
                            <div class="row g-5 g-xxl-8">
                                ...
                                <div class="col-xl-6">
                                    <div class="card mb-5 mb-xxl-8">
                                        ...
                                        <div class="card-body pb-0">
                                            ...
                                            <div class="mb-7">
                                                <!--begin::Text-->
                                                <div class="text-gray-800 mb-5">Lorem Ipsum is simply dummy text of
                                                    the
                                                    printing and typesetting industry.
                                                    Lorem Ipsum has been the industry's standard dummy text ever since
                                                    the
                                                    1500s, when the leap into electronic typesetting, remaining
                                                    essentially
                                                    unchanged.</div>
                                                <!--end::Text-->
                                                <!--begin::Toolbar-->
                        ...
                        <!--end::Tap pane-->
                        <!--begin::Tap pane-->
                        <div class="tab-pane fade" id="kt_stats_widget_16_tab_6">
            ...
            function renderTenDays() {
                ...
                for (const day of days) {
                    ...
                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger"
                        data-bs-toggle="tab"
                        href="#${day.contentId}">
                        <span class="fs-7 fw-semibold">${day.dayOfWeek}</span>
                        <span class="fs-6 fw-bold">${day.dayOfMonth}</span>
                    </a>
                    <!--end::Date-->
                `;
                ...
                for (let i = 0; i < 10; i++) {
                    ...
                    meetingsForDay.forEach(function(meeting) {
                        ...
                        <div class="d-flex align-items-center mb-6">
                            ...
                            <div class="flex-grow-1 me-5">
                                <div class="text-gray-800 fw-semibold fs-2">${meeting.time}</div>
                                <div class="text-gray-700 fw-semibold fs-6">${meeting.description}</div>
                                <div class="text-gray-400 fw-semibold fs-7">Lead by
                                    <a href="#" class="text-primary opacity-75-hover fw-semibold">${meeting.lead}</a>
                                </div>
                            </div>
